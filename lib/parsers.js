...
function JavaScriptNameExpression(name) {
    this.evaluate = function (context) {
        if (name == 'global')
            return global;
    }
...
function QualifiedCallExpression(qname, exprs) {
    this.evaluate = function (context) {
        var obj = qname.getTarget().evaluate(context);
        var fun;
        var fnname = qname.getName();
...
var rules = [
    ...
    get('JavaScriptExpression').log('JavaScriptExpression to Term').generate('Term'),
    get('JavaScriptExpression', 'LeftParenthesis', 'ExpressionList', 'RightParenthesis').generate('JavaScriptExpression', function (values) { return new JavaScriptCallExpression(values[0], values[2]); }),
    get('JavaScriptExpression', 'LeftParenthesis', 'RightParenthesis').generate('JavaScriptExpression', function (values) { return new JavaScriptCallExpression(values[0], []); }),
    get('JavaScriptExpression', 'Dot', 'Name').generate('JavaScriptExpression', function (values) { return new JavaScriptQualifiedNameExpression(values[0], values[2].getName()); }),   
    get('@', 'Name').log('Generating JavaScriptExpression').generate('JavaScriptExpression', function (values) { return new JavaScriptNameExpression(values[1].getName()); }),   
    //get('js', 'Dot', 'Name').log('Generating JavaScriptExpression').fail(function (source) { var next = source.next(); console.dir(next); source.push(next); }).generate('JavaScriptExpression', function (values) { return new JavaScriptNameExpression(values[2].getName()); }),   
...
//    get('Call').generate('Term'),
    ...
    get('QualifiedName', 'ExpressionList').generate('QualifiedCall', function (values) { return new QualifiedCallExpression(values[0], values[1]); }),
    get('QualifiedName').generate('QualifiedCall', function (value) { return new QualifiedCallExpression(value, []); }),
    get('QualifiedName', 'LeftParenthesis', 'ExpressionList', 'RightParenthesis').generate('QualifiedCall', function (values) { return new QualifiedCallExpression(values[0], values[2]); }),
    get('QualifiedName', 'LeftParenthesis', 'RightParenthesis').generate('QualifiedCall', function (values) { return new QualifiedCallExpression(values[0], []); }),
    
    // Qualified Name
    get('QualifiedName', 'Dot', 'Name').generate('QualifiedName', function (values) { return new QualifiedNameExpression(values[0], values[2].getName()); }),
    get('Name', 'Dot', 'Name').generate('QualifiedName', function (values) { return new QualifiedNameExpression(values[0], values[2].getName()); }),
    get('Integer', 'Dot', 'Name').generate('QualifiedName', function (values) { return new QualifiedNameExpression(values[0], values[2].getName()); }),
    get('String', 'Dot', 'Name').generate('QualifiedName', function (values) { return new QualifiedNameExpression(values[0], values[2].getName()); }),
