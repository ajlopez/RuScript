...
function QualifiedCallExpression(qname, exprs) {
    this.evaluate = function (context) {
        ...
        var fun = obj.$class.getInstanceMethod(qname.getName());
        var args = [];
...
var rules = [
    ...
    get('#').upTo('\n').skip(),
    get('"').upTo('"').generate('String', function (value) { return new ConstantExpression(value.substring(1, value.length - 1)); }),
