...
function InstanceNameExpression(name) {
    this.evaluate = function (context) {
...
//    get('Call').generate('Term'),
    ...
    get('InstanceName', 'Assign', 'Expression').generate('Expression', function (values) { return new AssignmentExpression(values[0], values[2]); }),
    ...
    get('@', 'Name').generate('InstanceName', function (values) { return new InstanceNameExpression(values[1].getName()); }),
    get('Name').generate('Term'),
    get('InstanceName').generate('Term'),
