...
var rules = [
    ...
    get('Name', 'LeftBracket', 'ExpressionList', 'RightBracket').generate('Call', function (values) { return new IndexedExpression(values[0], values[2]); }),
    get('Name', 'ExpressionList').generate('Call', function (values) { return new CallExpression(values[0].getName(), values[1]); }),
    get('Name', 'LeftParenthesis', 'ExpressionList', 'RightParenthesis').generate('Call', function (values) { return new CallExpression(values[0].getName(), values[2]); }),
    get('Name', 'LeftParenthesis', 'RightParenthesis').generate('Call', function (values) { return new CallExpression(values[0].getName(), []); }),
