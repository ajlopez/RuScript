...
var ClassExpression = expressions.ClassExpression,
    ...
    DefSelfExpression = expressions.DefSelfExpression,
...
var rules = [
    ...
    // Def
    get('def', 'self', 'Dot', 'Name', 'LeftParenthesis', 'RightParenthesis', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return new DefSelfExpression(values[2].getName(), [], new CompositeExpression(values[6])); }),
    get('def', 'self', 'Dot', 'Name', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return new DefSelfExpression(values[2].getName(), [], new CompositeExpression(values[4])); }),
