...
var IndexedExpression = x.IndexedExpression,
...
var rules = [
    ...
    get('class', 'Name', 'Less', 'Name', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.class(values[1].getName(), values[3].getName(), x.composite(values[5])); }),
    get('class', 'Name', 'EndOfStatement', 'Suite', 'end').generate('Expression', function (values) { return x.class(values[1].getName(), x.composite(values[3])); }),
