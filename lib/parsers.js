...
function QualifedCallExpression(qname, exprs) {
    this.evaluate = function (context) {
...
var rules = [
    ...
    // Qualified Call
    get('QualifiedName', 'ExpressionList').generate('Term', function (values) { return new QualifiedCallExpression(values[0], values[1]); }),
    get('QualifiedName').generate('Term', function (value) { return new QualifiedCallExpression(value[0], []); }),
    get('QualifiedName', 'LeftParenthesis', 'ExpressionList', 'RightParenthesis').generate('Term', function (values) { return new QualifiedCallExpression(values[0], values[2]); }),
    get('QualifiedName', 'LeftParenthesis', 'RightParenthesis').generate('Term', function (values) { return new QualifiedCallExpression(values[0], []); }),
