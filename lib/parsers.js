...
var rules = [
    ...
    get('Statement', 'Suite').generate('Suite', function (values) { return values[1].unshift(values[0]); }),
    get('Statement', 'end').generate('Suite', function (values) { return [values[0]]; }),
    get('Expression', 'end').generate('Suite', function (values) { return [values[0]]; }),
    get('end').generate('Suite', function () { return []; }),
