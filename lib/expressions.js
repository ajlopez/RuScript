...
module.exports = {
    class: function (name, supername, expr) { return new ClassExpression(name, supername, expr); },
    module: makeBinaryExpression(ModuleExpression),
    def: createDefExpression,
    defnamed: function (clsname, name, parnames, expr) { return new DefNamedExpression(clsname, name, parnames, expr); },
    ...
    equal: makeBinaryExpression(EqualExpression),
    notequal: makeBinaryExpression(NotEqualExpression),
    ...
    modulus: makeBinaryExpression(ModulusExpression),
